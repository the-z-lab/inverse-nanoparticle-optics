...
% Compute M_sc dotted with a vector. If the vector is a list of N particle
% dipoles, the result of M_sc is the electric field at N_E specific points.
% M_sc is 3N_E-by-3N.
%
% INPUTS
...
[Ep_perp, Ep_para] = RealSpaceTable_Field(r_table, a_uniq, xi);
...
E = -ComputeField_Field(x_E, x_p, a, p, box, n1, n2, xi, r_table, Ep_perp, Ep_para, tol);
